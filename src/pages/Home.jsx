  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen text-center px-4 sm:px-6 lg:px-8 py-10 overflow-hidden bg-gradient-to-br from-neutral-900 via-purple-950 to-black">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 w-full max-w-4xl">
        ...
        <p className="text-gray-300 text-base sm:text-lg md:text-xl max-w-xl md:max-w-2xl">
        ...
        {/* Quick links */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 w-full justify-center items-center">
          <a
            href="/buttons"
      ...
      {/* Footer */}
      <p className="relative z-10 text-gray-500 mt-6 sm:mt-8 text-xs sm:text-sm max-w-md md:max-w-xl px-2">
